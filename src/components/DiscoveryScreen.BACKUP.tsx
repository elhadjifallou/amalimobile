    ...
    try {
      ...
      const { error: likeError } = await supabase
        ...
        .upsert({
          ...
          like_type: action === 'pass' ? 'pass' : action,
      ...
      if ((action === 'like' || action === 'super_like') && !likeError) {
        ...
        if (profileError) {
          ...
          const notificationResult = await createNotification({
            ...
            title: action === 'super_like' 
              ? `${myProfile.name} vous a envoyé un Super Like !` 
              : `${myProfile.name} a aimé votre profil`,
            message: action === 'super_like'
              ? `${myProfile.name} vous a envoyé un Super Like 🌟`
              : `${myProfile.name} a liké votre profil ❤️`,
            fromUserId: userId,
